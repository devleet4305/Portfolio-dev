...
// Structured data for education and developer journey
const EDUCATION_DATA = [
  {
    title: "B.Sc in Computer Science & Engineering",
    institution: "Northern University of Business and Technology, Khulna",
    year: "Graduated",
    description: "Built a solid academic foundation in data structures, algorithms, database management systems, software engineering principles, and web technology fundamentals.",
    icon: <GraduationCap className="size-5" />,
  },
  {
    title: "Full-Stack MERN & Web Development Training",
    institution: "Professional Software Track",
    year: "Recent",
    description: "Specialized in modern full-stack application development using React.js, Next.js, TypeScript, Node.js, Express.js, MongoDB, and modern API integration.",
    icon: <Award className="size-5" />,
  },
  {
    title: "Independent Application Engineering",
    institution: "Project-Driven Portfolio Development",
    year: "Ongoing",
    description: "Actively designing, building, and deploying real-world web applications including property booking solutions, e-commerce platforms, and educational CMS systems.",
    ...
    >
      ...
      <div className="text-center mb-16 sm:mb-20">
        ...
        <p className="text-muted-foreground max-w-md mx-auto text-sm sm:text-base">
          My Computer Science foundation and ongoing software engineering milestones.
        </p>
      </div>

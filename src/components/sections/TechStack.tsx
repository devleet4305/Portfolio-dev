...
const StripeIcon = () => (
  <div className="size-5 bg-[#635BFF] text-white flex items-center justify-center font-bold text-[8px] rounded-sm select-none">S</div>
);

const DaisyUiIcon = () => (
  <div className="size-5 bg-[#1AD1A5] text-black flex items-center justify-center font-bold text-[8px] rounded-sm select-none">dUI</div>
);
...
const TECH_STACK_DATA = {
  ...
  "Auth & Services": [
    { name: "Firebase Auth", icon: <FirebaseIcon /> },
    { name: "JWT", icon: <JwtIcon /> },
    { name: "Stripe", icon: <StripeIcon /> },
    { name: "Cloudinary", icon: <Cloud className="size-5 text-[#3448C5]" /> },
  ],
  Tools: [
    { name: "Git", icon: <GithubIcon className="size-5 text-foreground" /> },
    { name: "GitHub", icon: <GithubIcon className="size-5 text-foreground" /> },
